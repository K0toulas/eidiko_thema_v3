...
COMPUTE_EXECS=(
    "/srv/homes/ggantsios/eidiko/benchmarks/NPB/NPB3.4-OMP/bin/ep.A.x"
    "/srv/homes/ggantsios/eidiko/benchmarks/NPB/NPB3.4-OMP/bin/ep.B.x"
    "/srv/homes/ggantsios/eidiko/benchmarks/NPB/NPB3.4-OMP/bin/ep.C.x"
)
IO_EXECS=(
...
cleanup() {
    ...
    pkill -f "ep\.[ABC]\.x" 2>/dev/null || true
...
run_test() {
    ...
    # Determine mode based on LD_PRELOAD
    local mode="cfs"
